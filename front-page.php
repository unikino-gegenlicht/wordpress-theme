...
<?php else: ?>
    <div class="content">
        <?= apply_filters( "the_content", get_theme_mod( "semester_break_premonition_text" )[ substr(get_user_locale(), 0, 2)  ] ?? "" ) ?>
    </div>
<?php endif; ?>
...
<?php if ( in_array( 'team', get_theme_mod( 'displayed_blocks', [] ) ) ): ?>
    ...
    <article id="team" class="py-5">
        <div class="page-content content">
            ...
            <h2><?= get_theme_mod( "team_block_title" )[ substr(get_user_locale(), 0, 2)  ] ?? "Please set this value!" ?></h2>
            <?php
            $raw = get_theme_mod( 'team_block_text' )[ substr(get_user_locale(), 0, 2)  ] ?? "";
    ...
    <article id="location" class="py-5">
        <div class="page-content content">
            <div class="">
                ...
                <?php endif; ?>
                <h2><?= get_theme_mod( "location_block_title" )[ substr(get_user_locale(), 0, 2)  ] ?? "Content Not Set" ?></h2>
                <?php
                $raw = get_theme_mod( 'location_block_text' )[ substr(get_user_locale(), 0, 2)  ] ?? "";
                echo apply_filters( "the_content", $raw );
                ?>
                <?php
    ...
    <article id="cooperations" class="py-5">
        <div class="page-content">
            ...
            <div class="content">
                ...
                <p>
                    <?php
                    $raw = get_theme_mod( 'coop_block_text' )[ substr(get_user_locale(), 0, 2)  ] ?? "";
                    echo apply_filters( "the_content", $raw );
                    ?>
                <p>
                    <?php get_template_part( 'src/partials/button', args: [
