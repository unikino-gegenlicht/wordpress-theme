...
class CooperationAndSupportersBlockCustomizer extends GGLCustomizerBase {
	...
	function __construct( WP_Customize_Manager $manager, int $priority = 20, array $additionalArgs = [] ) {
		parent::__construct( $manager, __( 'Cooperation Partners and Supporters', 'gegenlicht' ), __( 'Configure the content of the block showcasing our supporters and cooperation partners', 'gegenlicht' ), priority: $priority, section: self::SECTION, additionalArgs: array_merge( $additionalArgs, [
