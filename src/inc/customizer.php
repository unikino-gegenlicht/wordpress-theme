...
use inc\customizer\LocationBlockCustomizer;
use inc\customizer\LocationPageCustomizer;
use inc\customizer\NavigationBarCustomizer;
use inc\customizer\SemesterBreakCustomizer;
use inc\customizer\SingleCoopCustomizer;
use inc\customizer\SingleTeamCustomizer;
use inc\customizer\SocialMediasOptionsCustomizer;
use inc\customizer\SupporterPageCustomizer;
