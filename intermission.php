<div class="content">
    ...
    <h3 class="mt-0 pb-2"><?= get_theme_mod( "semester_break_tagline" )[ substr(get_user_locale(), 0, 2)  ] ?? "" ?></h3>
</div>
<?php
/**
...
if ( $query->have_posts() ):
    ...
    <div class="content pt-2">
        <?= apply_filters( "the_content", get_theme_mod( "semester_break_pre_events_text" )[ substr(get_user_locale(), 0, 2)  ] ?? "" ) ?>
    </div>
    <?php
    ...
    ?>
    <div class="content pt-2">
        <?= apply_filters( "the_content", get_theme_mod( "semester_break_post_events_text" )[ substr(get_user_locale(), 0, 2)  ] ?? "" ) ?>
    </div>
<?php endif; ?>
<div class="content pt-2">
    <?= apply_filters( "the_content", get_theme_mod( "semester_break_text" )[ substr(get_user_locale(), 0, 2)  ] ?? "" ) ?>
</div>
<div class="content">
    <h3><?= esc_html__( "What we have shown so far", "gegenlicht" ) ?></h3>
    <div class="pt-2">
        <?= apply_filters( "the_content", get_theme_mod( "semester_break_archive_text" )[ substr(get_user_locale(), 0, 2)  ] ?? "" ) ?>
